...
dir_name = "image_0526_valid"
out_dir_name = "image_0526_valid"
task_config = "../../bridge_data/configs/image_0526_test.yaml"
test_name = "test"
...
output_image_dir = "../image_output/image_0526_test"
...
if output_image_flg==1:
    for imid in check_image_list:
        ...
        each_image = cv2.imread("../../bridge_data/image_0526/" + file_name)
